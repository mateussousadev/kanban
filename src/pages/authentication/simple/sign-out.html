        ...
        <div class="row flex-center min-vh-100 py-5">
          <div class="col-sm-10 col-md-8 col-lg-5 col-xl-6 col-xxl-4">
            <div class="text-center mb-6 mx-auto"><img class="mb-7 d-dark-none" src="../../../assets/img/spot-illustrations/1.png" alt="phoenix" /><img class="mb-7 d-light-none" src="../../../assets/img/spot-illustrations/dark_1.png" alt="phoenix" />
              ...
              <div class="d-grid"><a class="btn btn-primary" href="../../../pages/authentication/simple/sign-in.html"><span class="fas fa-angle-left me-2"></span>Go to sign in page</a></div>
            </div>
          </div>
        </div>
      </div>
